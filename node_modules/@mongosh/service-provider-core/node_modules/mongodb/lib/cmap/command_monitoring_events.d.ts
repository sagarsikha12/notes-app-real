...
export declare class CommandSucceededEvent {
     ...
     */
    constructor(connection: Connection, command: WriteProtocolMessageType, reply: Document | undefined, started: number);
    get hasServiceId(): boolean;
}
/**
...
export declare class CommandFailedEvent {
     ...
     * @param started - a high resolution tuple timestamp of when the command was first sent, to calculate duration
     */
    constructor(connection: Connection, command: WriteProtocolMessageType, error: Error | Document, started: number);
    get hasServiceId(): boolean;
}
