...
}, dataToBeCompressed: Buffer, callback: Callback<Buffer>): void;
export declare function decompress(compressorID: Compressor, compressedData: Buffer, callback: Callback<Buffer>): void;
