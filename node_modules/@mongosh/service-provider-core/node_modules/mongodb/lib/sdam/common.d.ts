...
/** @internal */
export declare function clearAndRemoveTimerFrom(timer: NodeJS.Timeout, timers: TimerQueue): boolean;
/** @public */
...
export declare function resolveClusterTime(topology: Topology | ClientSession, $clusterTime: ClusterTime): void;
