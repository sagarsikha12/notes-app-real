import { AnyOptions, Callback, HostAddress } from './utils';
 ...
 */
export declare function resolveSRVRecord(options: MongoOptions, callback: Callback<HostAddress[]>): void;
/**
 ...
 */
export declare function checkTLSOptions(options: AnyOptions): void;
declare class CaseInsensitiveMap extends Map<string, any> {
...
export declare const DEFAULT_OPTIONS: CaseInsensitiveMap;
export {};
