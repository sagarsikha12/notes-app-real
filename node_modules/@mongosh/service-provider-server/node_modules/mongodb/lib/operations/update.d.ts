...
export declare class UpdateOneOperation extends UpdateOperation {
    ...
    execute(server: Server, session: ClientSession, callback: Callback<UpdateResult | Document>): void;
}
/** @internal */
...
export declare function makeUpdateStatement(filter: Document, update: Document, options: UpdateOptions & {
    multi?: boolean;
}): UpdateStatement;
