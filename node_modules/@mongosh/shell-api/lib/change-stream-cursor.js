...
let ChangeStreamCursor = class ChangeStreamCursor extends decorators_1.ShellApiWithMongoClass {
    ...
    async hasNext() {
        deprecation_warning_1.printWarning('If there are no documents in the batch, hasNext will block. Use tryNext if you want to check if there ' +
            'are any documents without waiting.', this._mongo._internalState.context.print);
    ...
    async next() {
        deprecation_warning_1.printWarning('If there are no documents in the batch, next will block. Use tryNext if you want to check if there are ' +
            'any documents without waiting.', this._mongo._internalState.context.print);
