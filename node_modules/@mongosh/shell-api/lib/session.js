...
let Session = class Session extends decorators_1.ShellApiWithMongoClass {
    ...
    advanceClusterTime() {
        throw new errors_1.MongoshUnimplementedError('Calling advanceClusterTime is not currently supported due it not being supported in the driver, see NODE-2843.', errors_1.CommonErrors.NotImplemented, error_codes_1.blockedByDriverMetadata('Session.advanceClusterTime'));
    }
    async endSession() {
