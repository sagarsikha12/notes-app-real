...
let Mongo = class Mongo extends decorators_1.ShellApiClass {
    constructor(internalState, uri, fleOptions, otherOptions, sp) {
        var _a, _b, _c;
        super();
    ...
    async _displayBatchSize() {
        var _a;
        return (_a = this._internalState.displayBatchSizeFromDBQuery) !== null && _a !== void 0 ? _a : await this._internalState.shellApi.config.get('displayBatchSize');
    }
    [enums_1.asPrintable]() {
    ...
    async connect(user, pwd) {
        ...
        if (this._fleOptions && !this._explicitEncryptionOnly) {
            const extraOptions = {
                ...
                ...((_d = await ((_c = (_b = this._internalState.evaluationListener) === null || _b === void 0 ? void 0 : _b.startMongocryptd) === null || _c === void 0 ? void 0 : _c.call(_b))) !== null && _d !== void 0 ? _d : {})
            };
    ...
    setSecondaryOk() {
        throw new errors_1.MongoshDeprecatedError('Setting secondaryOk is deprecated, use setReadPref instead.');
    }
