...
exports.addSourceToResults = exports.classPlatforms = exports.platforms = exports.classDeprecated = exports.returnType = exports.shellCommandCompleter = exports.directShellCommand = exports.returnsPromise = exports.nonAsyncFunctionsReturningPromises = exports.topologies = exports.deprecated = exports.apiVersions = exports.serverVersions = exports.signatures = exports.shellApiClassNoHelp = exports.shellApiClassDefault = exports.toIgnore = exports.toShellResult = exports.getShellApiType = exports.ShellApiValueClass = exports.ShellApiWithMongoClass = exports.ShellApiClass = void 0;
...
class ShellApiWithMongoClass extends ShellApiClass {
    get _internalState() {
        var _a;
        return (_a = this._mongo) === null || _a === void 0 ? void 0 : _a._internalState;
    }
}
...
function getShellApiType(rawValue) {
    var _a;
    return (_a = (rawValue && rawValue[enums_1.shellApiType])) !== null && _a !== void 0 ? _a : null;
}
...
function wrapWithApiChecks(fn, className) {
    const wrapper = fn.returnsPromise ?
        markImplicitlyAwaited(async function (...args) {
            ...
            const interruptFlag = interruptor_1.checkInterrupted(internalState);
            ...
            try {
                ...
                throw (_b = internalState === null || internalState === void 0 ? void 0 : internalState.transformError(e)) !== null && _b !== void 0 ? _b : e;
            }
            finally {
                if (interrupt) {
                    interrupt.destroy();
            ...
            interruptor_1.checkInterrupted(internalState);
            return result;
        }) : function (...args) {
        var _a;
        const internalState = getShellInternalState(this);
        ...
        try {
            ...
            throw (_a = internalState === null || internalState === void 0 ? void 0 : internalState.transformError(e)) !== null && _a !== void 0 ? _a : e;
        }
        interruptor_1.checkInterrupted(internalState);
        return result;
    };
...
function checkForDeprecation(internalState, className, fn) {
...
function getShellInternalState(apiClass) {
    if (!apiClass[enums_1.shellApiType]) {
        throw new errors_1.MongoshInternalError('getShellInternalState can only be called for functions from shell API classes');
    }
    return apiClass._internalState;
}
