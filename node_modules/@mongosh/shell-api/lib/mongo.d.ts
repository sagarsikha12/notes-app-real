...
export default class Mongo extends ShellApiClass {
    ...
    constructor(internalState: ShellInternalState, uri?: string, fleOptions?: ClientSideFieldLevelEncryptionOptions, otherOptions?: {
    ...
    setSlaveOk(): void;
    setSecondaryOk(): void;
    watch(pipeline?: Document[], options?: ChangeStreamOptions): Promise<ChangeStreamCursor>;
