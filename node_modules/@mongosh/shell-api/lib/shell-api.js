...
let ShellApi = class ShellApi extends decorators_1.ShellApiClass {
    constructor(internalState) {
        ...
        this.DBQuery = new dbquery_1.DBQuery(internalState);
    ...
    async exit(exitCode) {
        ...
        helpers_1.assertCLI(this._internalState.initialServiceProvider.platform, 'the exit/quit commands');
        await this._internalState.close(true);
        await ((_b = (_a = this._internalState.evaluationListener).onExit) === null || _b === void 0 ? void 0 : _b.call(_a, exitCode));
    ...
    async Mongo(uri, fleOptions, otherOptions) {
        helpers_1.assertCLI(this._internalState.initialServiceProvider.platform, 'new Mongo connections');
        const mongo = new mongo_1.default(this._internalState, uri, fleOptions, otherOptions);
        await mongo.connect();
    ...
    async connect(uri, user, pwd) {
        ...
        helpers_1.assertCLI(this._internalState.initialServiceProvider.platform, 'new Mongo connections');
        const mongo = new mongo_1.default(this._internalState, uri);
    ...
    async load(filename) {
        ...
        const { resolvedFilename, evaluate } = await this._internalState.evaluationListener.onLoad(filename);
    ...
    async enableTelemetry() {
        var _a, _b;
        const result = await ((_b = (_a = this._internalState.evaluationListener).setConfig) === null || _b === void 0 ? void 0 : _b.call(_a, 'enableTelemetry', true));
        if (result === 'success') {
    ...
    async disableTelemetry() {
        var _a, _b;
        const result = await ((_b = (_a = this._internalState.evaluationListener).setConfig) === null || _b === void 0 ? void 0 : _b.call(_a, 'enableTelemetry', false));
        if (result === 'success') {
