...
const deprecation_warning_1 = require("./deprecation-warning");
...
let Collection = class Collection extends decorators_1.ShellApiWithMongoClass {
    ...
    async aggregate(...args) {
        ...
        const providerCursor = this._mongo._serviceProvider.aggregate(this._database._name, this._name, pipeline, { ...this._database._baseOptions, ...aggOptions }, dbOptions);
    ...
    async bulkWrite(operations, options = {}) {
        ...
        const result = await this._mongo._serviceProvider.bulkWrite(this._database._name, this._name, operations, { ...this._database._baseOptions, ...options });
    ...
    async count(query = {}, options = {}) {
        ...
        return this._mongo._serviceProvider.count(this._database._name, this._name, query, { ...this._database._baseOptions, ...options });
    }
    async countDocuments(query, options = {}) {
        this._emitCollectionApiCall('countDocuments', { query, options });
        return this._mongo._serviceProvider.countDocuments(this._database._name, this._name, query, { ...this._database._baseOptions, ...options });
    }
    async deleteMany(filter, options = {}) {
        ...
        const result = await this._mongo._serviceProvider.deleteMany(this._database._name, this._name, filter, { ...this._database._baseOptions, ...options });
        if (options.explain) {
    ...
    async deleteOne(filter, options = {}) {
        ...
        const result = await this._mongo._serviceProvider.deleteOne(this._database._name, this._name, filter, { ...this._database._baseOptions, ...options });
        if (options.explain) {
            return helpers_1.markAsExplainOutput(result);
        }
        return new index_1.DeleteResult(!!result.acknowledged, result.deletedCount);
    ...
    async distinct(field, query, options = {}) {
        ...
        return helpers_1.maybeMarkAsExplainOutput(await this._mongo._serviceProvider.distinct(this._database._name, this._name, field, query, { ...this._database._baseOptions, ...options }), options);
    }
    ...
    find(query, projection, options = {}) {
        ...
        const cursor = new index_1.Cursor(this._mongo, this._mongo._serviceProvider.find(this._database._name, this._name, query, { ...this._database._baseOptions, ...options }));
        this._mongo._internalState.currentCursor = cursor;
        return cursor;
    }
    ...
    async findOne(query = {}, projection, options = {}) {
        ...
        return new index_1.Cursor(this._mongo, this._mongo._serviceProvider.find(this._database._name, this._name, query, { ...this._database._baseOptions, ...options })).limit(1).tryNext();
    }
    async renameCollection(newName, dropTarget) {
        ...
        try {
            await this._mongo._serviceProvider.renameCollection(this._database._name, this._name, newName, { ...this._database._baseOptions, dropTarget: !!dropTarget });
            return {
                ok: 1
            };
        }
    ...
    async findOneAndDelete(filter, options = {}) {
        ...
        const result = await this._mongo._serviceProvider.findOneAndDelete(this._database._name, this._name, filter, { ...this._database._baseOptions, ...options });
        if (options.explain) {
            return helpers_1.markAsExplainOutput(result);
        }
        return result.value;
    ...
    async insert(docs, options = {}) {
        deprecation_warning_1.printDeprecationWarning('Collection.insert() is deprecated. Use insertOne, insertMany, or bulkWrite.', this._mongo._internalState.context.print);
        ...
        const result = await this._mongo._serviceProvider.insertMany(this._database._name, this._name, docsToInsert, { ...this._database._baseOptions, ...options });
    ...
    async insertOne(doc, options = {}) {
        ...
        const result = await this._mongo._serviceProvider.insertOne(this._database._name, this._name, { ...doc }, { ...this._database._baseOptions, ...options });
    ...
    async remove(query, options = {}) {
        deprecation_warning_1.printDeprecationWarning('Collection.remove() is deprecated. Use deleteOne, deleteMany, findOneAndDelete, or bulkWrite.', this._mongo._internalState.context.print);
        ...
        const result = await this._mongo._serviceProvider[method](this._database._name, this._name, query, { ...this._database._baseOptions, ...removeOptions });
    ...
    async replaceOne(filter, replacement, options = {}) {
        ...
        const result = await this._mongo._serviceProvider.replaceOne(this._database._name, this._name, filter, replacement, { ...this._database._baseOptions, ...options });
    ...
    async update(filter, update, options = {}) {
        deprecation_warning_1.printDeprecationWarning('Collection.update() is deprecated. Use updateOne, updateMany, or bulkWrite.', this._mongo._internalState.context.print);
        ...
        let result;
        if (options.multi) {
            result = await this._mongo._serviceProvider.updateMany(this._database._name, this._name, filter, update, { ...this._database._baseOptions, ...options });
        }
        else {
            result = await this._mongo._serviceProvider.updateOne(this._database._name, this._name, filter, update, { ...this._database._baseOptions, ...options });
        }
        if (options.explain) {
            return helpers_1.markAsExplainOutput(result);
        }
    ...
    async updateMany(filter, update, options = {}) {
        ...
        const result = await this._mongo._serviceProvider.updateMany(this._database._name, this._name, filter, update, { ...this._database._baseOptions, ...options });
        if (options.explain) {
            return helpers_1.markAsExplainOutput(result);
        }
        return new index_1.UpdateResult(!!result.acknowledged, result.matchedCount, result.modifiedCount, result.upsertedCount, result.upsertedId);
    ...
    async updateOne(filter, update, options = {}) {
        ...
        const result = await this._mongo._serviceProvider.updateOne(this._database._name, this._name, filter, update, { ...this._database._baseOptions, ...options });
        if (options.explain) {
            return helpers_1.markAsExplainOutput(result);
        }
        return new index_1.UpdateResult(!!result.acknowledged, result.matchedCount, result.modifiedCount, result.upsertedCount, result.upsertedId);
    ...
    async createIndex(keys, options = {}) {
        ...
        const names = await this._mongo._serviceProvider.createIndexes(this._database._name, this._name, [spec], { ...this._database._baseOptions, ...options });
    ...
    async drop() {
        ...
        try {
            return await this._mongo._serviceProvider.dropCollection(this._database._name, this._name, this._database._baseOptions);
        }
        catch (error) {
            if (error.codeName === 'NamespaceNotFound') {
                this._mongo._internalState.messageBus.emit('mongosh:warn', {
                    method: 'drop',
                    class: 'Collection',
    ...
    async runCommand(commandName, options) {
        ...
        return await this._mongo._serviceProvider.runCommandWithCheck(this._database._name, cmd, this._database._baseOptions);
    }
    ...
    async stats(originalOptions = {}) {
        ...
        const result = await this._mongo._serviceProvider.runCommandWithCheck(this._database._name, {
    ...
    async latencyStats(options = {}) {
        ...
        const providerCursor = this._mongo._serviceProvider.aggregate(this._database._name, this._name, pipeline, this._database._baseOptions);
        return await providerCursor.toArray();
    }
    async initializeOrderedBulkOp() {
        this._emitCollectionApiCall('initializeOrderedBulkOp');
        const innerBulk = await this._mongo._serviceProvider.initializeBulkOp(this._database._name, this._name, true, this._database._baseOptions);
    ...
    async initializeUnorderedBulkOp() {
        ...
        const innerBulk = await this._mongo._serviceProvider.initializeBulkOp(this._database._name, this._name, false, this._database._baseOptions);
    ...
    async mapReduce(map, reduce, optionsOrOutString) {
        deprecation_warning_1.printDeprecationWarning('Collection.mapReduce() is deprecated. Use an aggregation instead.\nSee https://docs.mongodb.com/manual/core/map-reduce for details.', this._mongo._internalState.context.print);
    ...
    async getShardVersion() {
        ...
        return await this._mongo._serviceProvider.runCommandWithCheck(enums_1.ADMIN_DB, {
