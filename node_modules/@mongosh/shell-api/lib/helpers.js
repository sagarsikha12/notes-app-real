...
async function getPrintableShardStatus(db, verbose) {
    const result = {};
...
async function getConfigDB(db) {
    ...
    if (helloResult.msg !== 'isdbgrid') {
        throw new errors_1.MongoshInvalidInputError('Not connected to a mongos', error_codes_1.ShellApiErrors.NotConnectedToMongos);
    }
...
async function setHideIndex(coll, index, hidden) {
    ...
    return await coll._mongo._serviceProvider.runCommandWithCheck(coll._database._name, {
        collMod: coll._name,
        index: cmd
